...
def send_tg_notification(action, chat_id, reward=None):
    ...
    Аргументы:
        ...
        reward : str, optional
            Награда, которую можно получить за выполнение задачи. Если не указано, сообщение будет без упоминания награды.

    Возвращает:
        None

    Описание:
        Формирует сообщение на основе переданных аргументов и отправляет его в указанный чат Telegram при помощи функции send_telegram_message.
